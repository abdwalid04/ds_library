...
from ds_library.embedding_service import EmbeddingService
...
def main(args):
    ...
    reduced_embeddings = dim_reduc.reduce(sentences=sentences, save_path=args.output_npy)

    # Plot the results
    plot_embeddings_clusters(
        embeddings=reduced_embeddings,
        clusters=clusters,
        title=f"{args.method.upper()} {args.num_components}D Clustering",
